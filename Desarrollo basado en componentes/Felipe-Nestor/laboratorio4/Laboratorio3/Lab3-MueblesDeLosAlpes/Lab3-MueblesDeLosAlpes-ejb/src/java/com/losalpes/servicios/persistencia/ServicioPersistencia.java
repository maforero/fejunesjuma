...
public class ServicioPersistencia implements IServicioPersistenciaMockLocal,IServicioPersistenciaMockRemote, Serializable {
    ...
    @Override
    public <T> T executeNamedQuerySingleResult(String namedQuery, Object... params) {
       return (T) createNamedQuery(namedQuery, params).getSingleResult();
    }

    @Override
    public <T> List<T> executeNamedQueryResultList(String namedQuery, Object... params) {
       return (List<T>) createNamedQuery(namedQuery, params).getResultList();
    }
    
    private Query createNamedQuery(String namedQuery, Object... params) {
